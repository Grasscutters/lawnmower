...
export default class Logger {
  ...
  private raw(...args: string[]) {
    ...
    console.log(
      `[${this.getDate().white.bold}] <${this.name[this.color].bold}>`,
      ...args
    );
  }
  ...
  public error(e: Error) {
    console.log(
      `[${this.getDate().white.bold}] ${`ERROR<${this.name}>`.bgRed.bold}`,
      e.message
    );
  ...
  public warn(...args: string[]) {
    console.log(
      `[${this.getDate().white.bold}] ${"WARN".bgYellow.bold}`,
      ...args
    );
  }
  ...
  public debug(...args: any) {
    console.log(
      `[${this.getDate().white.bold}] ${`DEBUG<${this.name}>`.bgBlue.bold}`,
      ...args
    );
  }
}
